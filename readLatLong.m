...
legend('Network location', 'GPS location', 'B615 (start)', 'B616A (end)');
d=haversineFunc(B616ALat,B615Lat, B616ALong, B615Long);
...
%d2 = sqrt(dy^2+dx^2);
[dx,dy,d2] = diffLatLong(B616ALat,gpsLat,B616ALong,gpsLong);
